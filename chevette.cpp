...
Textura Chevette::tCarroPreto("Texturas/Carros/Chevette/chevettePreto.bmp",false);
Textura Chevette::tCarroVermelho("Texturas/Carros/Chevette/chevetteVermelho.bmp",false);
Textura Chevette::tCarroAmarelo("Texturas/Carros/Chevette/chevetteAmarelo.bmp",false);
Textura Chevette::tCarroVerde("Texturas/Carros/Chevette/chevetteVerde.bmp",false);
Textura Chevette::tCarroRosa("Texturas/Carros/Chevette/chevetteRosa.bmp",false);
Textura Chevette::tCarroBranco("Texturas/Carros/Chevette/chevetteBranco.bmp",false);
Textura Chevette::tRoda("Texturas/Carros/Chevette/roda.bmp",false);


Chevette::Chevette(Ponto *centro,Vetor *n, Vetor *v, int cor): Carro(centro, n, v,10.0f, 0.01f, 0.4f,0.08f, 1.0f, 0.5f,0.36f,0.2f){
	this->setCor(cor);	
...
void Chevette::roda_origem(int raio) { //método que desenha uma roda na origem para que depois ela possa ser colocada na sua posição devida...
...
void Chevette::desenhaRodas() { //método que desenha as rodas girando...
	int static raio = 3;
